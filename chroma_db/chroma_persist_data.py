...
chroma_path = "db/chroma_persist_data"
chroma_client = chromadb.PersistentClient(path=chroma_path)
collection_name = "test_collection"
collection = chroma_client.get_or_create_collection(collection_name, embedding_function=default_embedding)
...
# Define a query text
query_text = "What does Microsoft do?"
